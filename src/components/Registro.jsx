...
export function Registro({ changeView }) { // Asegúrate de desestructurar changeView del objeto de props
    ...
    const handleSubmit = (e) => {
        ...
        changeView('login'); // Esto cambiará la vista a Formulario
    };
    ...
    return (
        <section className="Registro">
            ...
            <form className="formulario" onSubmit={handleSubmit}>
                ...
                <button type="submit">Registrarse</button> {/* Asegúrate de que el botón sea de tipo submit para que se ejecute handleSubmit al hacer clic */}
            </form>
